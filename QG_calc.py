...
def calculate_result():
    ...
    gravity_threshold = float(thresh_gravity_entry.get()) * 10**-8
...
# Tab 2 - settings
# Create and place labels and entry widgets
thresh_gravity_label = ttk.Label(tab2, text=f"Detectability Threshold in microgal (m/s{superscript_minus}{superscript_8}) for QG:")
...
# Create and place labels and entry widgets
thresh_gradio_label = ttk.Label(tab2, text=f"Detectability Threshold in Eotvas (10{superscript_minus}{superscript_9}s{superscript_minus}{superscript_2}) for QGradio:")
